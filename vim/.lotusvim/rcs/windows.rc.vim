...
" custom file_rec, ignore some directories
...
call denite#custom#var('grep', 'default_opts', ['-inH', '--exclude=.tags', '--exclude-dir=.tox', '--exclude-dir=.git', '--exclude-dir=node_modules', '--exclude=*.pyc'])
...
call denite#custom#map('normal', '<M-q>', '<denite:quit>', 'noremap')
call denite#custom#map('insert', '<M-r>', '<denite:redraw>', 'noremap')
