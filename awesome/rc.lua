...
beautiful.init("~/.config/awesome/themes/apporc/theme.lua")
...
awful.util.spawn_with_shell("if [ $(tmux ls 2>&1 | grep apporc |wc -l) -eq 1 ]; then urxvt -e tmux source-file /home/apporc/.tmux/apporc.conf; fi")
