...
awful.util.tagnames = { "  REMOTE  ", "  TERMINAL  ", "  DOCUMENTS  ", "  WEB  ", "  IDE  ", "  MULTIMEDIA  ", "  KVM  " }
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey, "Shift"}, "w", function () if beautiful.weather then beautiful.weather.show(7) end end),
...
awful.rules.rules = {
    ...
    -- Set Firefox to always map on the first tag on screen 4.
    { rule = { class = "Firefox" },
    ...
    { rule = { class = "Gimp", role = "gimp-image-window" },
          properties = { screen = 1, tag = screen[1].tags[5], maximized = true } },
}
-- }}}
